...
<div class="prodaja-nekretnina-post">
  <a class="prodaja-nekretnina-link" href="${link}" target="_blank" rel="noopener">
    <div class="prodaja-nekretnina-post-image-container">
      <img class="prodaja-nekretnina-post-image" src="${img}" alt="${title}" style="width:100%;max-width:100%;height:auto;max-height:500px;object-fit:contain;display:block;margin:0 auto;border:none;box-sizing:border-box;">
    </div>
